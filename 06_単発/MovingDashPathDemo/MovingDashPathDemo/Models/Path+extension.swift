...
extension Path {
    ...
    static let crown: Path = Path { path in
        path.move(to: CGPoint(x: 84.609299, y: 20.5695))
        path.addLine(to: CGPoint(x: 125.579002, y: 17.6653))
        path.addCurve(to: CGPoint(x: 128.404007, y: 22.7234),
                      control1: CGPoint(x: 128.283005, y: 17.4736),
                      control2: CGPoint(x: 129.985992, y: 20.5212))
