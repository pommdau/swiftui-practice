    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        ...
        init(_ pageViewController: PageViewController) {
            ...
            controllers = parent.pages.map { page in
                // UIHostingControllerで明示的にviewの背景色を設定しないといけない
                // [How to set UIHostingController's background color to clear?](https://stackoverflow.com/questions/63492043/how-to-set-uihostingcontrollers-background-color-to-clear)
